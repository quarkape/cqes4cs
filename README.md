...
- 本科毕设，很多功能都是本科毕业后写的，代码逻辑比较乱，sql语句那一块跟别提了，现在让我看我自己也看不懂。
- 计划重构项目的。打算增加一个根据学生提交的比赛记录，生成学习报告的功能（之前有这个功能，但是后来砍掉了）
- 打算增加一个在线遍历自己“学习报告”的功能，进一步衍生出编辑简历、导出简历的功能。
- 打算增加一个共享加分配置文件的功能，可以上传自己编写的加分配置文件。
