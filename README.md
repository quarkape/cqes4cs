...
:warning: 建议拉取分支v1.1，该分支修复了重要的bug
...
- MySQL，[你可以参考这篇文章使用phpstudy安装MySQL](https://www.itheima.com/news/20191129/171021.html)，版本要求，低于v7.0，本项目使用的是v5.7.5，如果需要使用高版本，请参考后面教程部分将`only_full_group_by`字段关闭。
